    ...
    return (
        <div className="anuncios-container">
            <div className="anuncio-1">
                <img src={pythonBurguer} alt="Burguer Artesanal Python"/>
                <div className="anuncio-1-text"> 
                    ...
                    <p className="promo-fritas">Acompanha Fritas</p>
                    <button className="button-pedido">Pedir Agora</button>
                    <p>R$ 34,90</p>
                </div>
            </div>
